  ...
  const getData = async () => {
    try {
      ...
      if (response.status === 200) {
        ...
        // console.log(
        //   responseJson.data.opening_price,
        //   responseJson.data.max_price,
        //   responseJson.data.min_price,
        //   responseJson.data.prev_closing_price
        // );
        ...
        setState((prev: any) => {
          return [
            ...prev,
            {
              x: new Date(Number(responseJson.data.date)),
              y: [
                responseJson.data.opening_price,
                responseJson.data.max_price,
                responseJson.data.min_price,
